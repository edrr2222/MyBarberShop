...
<div class="panel">
    ...
    @else
        <table>
            <thead>
                <tr><th>Nombre</th><th>Categoría</th><th>Precio</th><th>Duración</th><th>Aplica sello</th><th>Estado</th><th></th></tr>
            </thead>
            <tbody>
                @foreach ($servicios as $servicio)
                    <tr>
                        <td>{{ $servicio->nombre }}</td>
                        <td>{{ \App\Models\Servicio::CATEGORIAS[$servicio->categoria] ?? $servicio->categoria }}</td>
